 ...
 * @Description Qrcode grid collection model
 * @author      W3solver
 * @copyright   Copyright (c) 2017 w3solver
 */
namespace W3solver\Qrcode\Model\ResourceModel\Qrcodelist\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use W3solver\Qrcode\Model\ResourceModel\QrcodeList\Collection as QrcodeCollection;

/**
 * Class Collection
 * Collection for displaying grid
 */
class Collection extends QrcodeCollection implements SearchResultInterface 
{
